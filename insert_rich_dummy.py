...
clubs_master = [
    {
        ...
        'cat': '학술',
        'tags': ['코딩', '개발'],
        'intro': '함께 배우고 성장하는 코딩 스터디',
        'pres': '김코딩',
        'activity': '매주 알고리즘 풀이, 팀 웹/앱 프로젝트 진행 및 하반기 해커톤 참가',
        'awards': ['2025 대학생 해커톤 우수상', '2024 오픈소스 프로젝트 대상'],
    ...
    },
    {
        ...
        'cat': '학술',
        'tags': ['알고리즘', 'PS'],
        'intro': '코딩테스트 완벽 대비 알고리즘 동아리',
        'pres': '이알고',
        'activity': '백준/프로그래머스 문제 풀이 스터디, 모의 코딩테스트 및 코드 리뷰',
        'awards': ['ICPC 서울 리전 본선 진출'],
    ...
    },
    {
        ...
        'cat': '공연',
        'tags': ['힙합', '음악'],
        'intro': '비트 위에서 자유롭게 표현하는 힙합 동아리',
        'pres': '박힙합',
        'activity': '정기 힙합 정기공연, 자작곡 음원 발매 및 믹스테잎 제작',
        'awards': ['전국 대학 힙합 동아리 연합전 2위'],
    ...
    },
    {
        ...
        'cat': '공연',
        'tags': ['오케스트라', '클래식'],
        'intro': '아름다운 클래식 선율을 만드는 아카데미 오케스트라',
        'pres': '최선율',
        'activity': '봄/가을 정기 연주회, 지역 사회 재능기부 봉사 연주회',
        'awards': ['대학 오케스트라 페스티벌 최우수상'],
        'ideal': '현악기, 관악기, 타악기 연주 경험이 있는 학생',
        'benefits': '악기 보관함 제공, 전문 지휘자 레슨',
        'faqs': [
            {'question': '악기를 직접 가져와야 하나요?', 'answer': '대형 악기(첼로, 타악기 등)는 동아리방 악기를 이용할 수 있습니다.'}
        ]
    },
    {
        'name': '어울림봉사단',
        'cat': '봉사',
        'tags': ['봉사', '멘토링'],
        'intro': '지역 아동들과 함께하는 교육 멘토링 봉사',
        'pres': '정봉사',
        'activity': '초/중학생 과목 학습 지도, 창의 체험활동 및 주말 나들이 봉사',
        'awards': ['보건복지부 장관 표창 우수봉사동아리'],
    ...
    },
    {
        ...
        'cat': '운동',
        'tags': ['축구', '풋살'],
        'intro': '땀 흘리며 우정을 나누는 열정 축구 동아리',
        'pres': '윤축구',
        'activity': '주 1회 정기 풋살/축구 경기, 대학 대항전 축구 대회 참가',
        'awards': ['2025 총장배 축구대회 우승'],
    ...
    },
    {
        ...
        'awards': ['시도 전국 배드민턴 동호인 대회 단식 1위'],
    ...
    },
    {
        ...
        'awards': ['전국 대학 주짓수 챔피언십 체급별 메달 수여'],
    ...
    },
    {
        ...
        'cat': '취미교양',
        'tags': ['사진', '출사'],
        'intro': '카메라로 담는 아름다운 풍경과 순간들',
        'pres': '한출사',
        'activity': '월 1회 근교 정기 출사, 카메라 기초 강좌, 학기말 사진 전시회',
        'awards': ['대한민국 청소년/대학생 사진 공모전 입선'],
        'ideal': '사진 촬영을 좋아하고 여행을 즐기는 모든 분',
        'benefits': '스마트폰 사진과 미러리스 사진 팁 전수, 사진집 출판',
        'faqs': [
    ...
    },
    {
        ...
        'cat': '취미교양',
        'tags': ['요리', '베이킹'],
        'intro': '맛있는 요리와 디저트를 만드는 쿠킹 동아리',
        'pres': '서요리',
        'activity': '격주 쿠킹 클래스 및 베이킹, 세계 요리 시식회',
        'awards': ['대학생 창의 요리 경연대회 동상'],
        'ideal': '요리와 베이킹에 관심이 많고 맛있는 음식을 나누고 싶은 사람',
    ...
    },
    {
        ...
        'cat': '취미교양',
        'tags': ['커피', '드립'],
        'intro': '원두 핸드드립과 커핑을 즐기는 커피 동아리',
        'pres': '신커피',
        'activity': '다양한 싱글 오리진 원두 커핑, 에스프레소 추출 연습, 카페 탐방',
        'awards': ['대학생 바리스타 챔피언십 참가'],
    ...
    },
    {
        ...
        'cat': '종교',
        'tags': ['기독교', '신앙'],
        'intro': '사랑과 은혜가 넘치는 기독교 동아리',
        'pres': '권신앙',
        'activity': '주간 순모임, 채플, 방학 수련회 및 미디어 사역',
        'awards': [],
        'ideal': '신앙을 나누고 건강한 공동체를 경험하고 싶은 신학생/일반생',
